  ...
  <body>
    ...
    <div class="container">
       ...
       <br><br>
        ...
        <a class="btn btn-primary" href="IncluirBlog.php" role="button">Incluir</a>
        <br><br>
        ...
        function Pergunta(id) {
          ...
          if (confirm("Deseja realmente excluir ?")) {
            window.location.replace("https://trabalho-3006.000webhostapp.com/blog/ExcluirBlog.php?id="+id);
